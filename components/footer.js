        ...
        <footer className="mt-[50px]">
            ...
            <Motion>
                <div className="flex justify-between items-center md:border-y-[1px] md:border-[#E2E8F0] py-[32px] md:flex-row flex-col mt-[50px] md:mt-o">
                    <Logo />
                    <ul class='footer flex items-center gap-[40px] md:flex-row flex-col md:mt-0 mt-[42px]'>
                        { linksArray.map(link => {
                                return (
                                    <li>
                                        <NavLink open={open} setOpen={setOpen} text={link.name} to={link.to} active={link.active} darkTheme={darkTheme} isFooter={true} />
                                    </li>
                                ) 
