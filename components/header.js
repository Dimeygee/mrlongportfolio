...
export const Header = () => {
    ...
    return(
        <header className="flex relative lg:flex-row flex-col">
            <div className="pt-[79px] lg:w-[50%]">
                <article>
                    <p className="p1 font-bold tracking-[-1.44195px] font-syne text-[#1A202C] opacity-0 translate-y-4 text-[46px] md:text-[72.999px]  text-center lg:text-left md:leading-[88px] leading-[53.2px] dark:text-[#A0AEC0]">
                        Digital Product <br />Designer <br />Crafting <br />"<span className="text-mrlongblue dark:text-white">Magic</span>"
                    </p>
                    <p className='p2 mt-[18px] mb-[34px] tracking-[-0.36px] text-[#2D3748] opacity-0 translate-y-4 text-lg font-outfit text-center lg:text-left font-normal leading-[25px] dark:text-[#CBD5E0]'>Do you have a billion-dollar idea and are looking for a product <br />designer to help bring it to life? If so, you would definitely need to <br />speak with me.</p>
                    <div className="btn flex gap-[24px] lg:flex-row flex-col lg:w-[100%] opacity-0 translate-y-4 w-[250px] mx-auto">
