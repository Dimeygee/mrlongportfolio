...
export const Project = ({content, image, title, mobileImg, projectID }) => {
    ...
    return(
        <div className={`selector_${projectID} py-[26px] px-[24px] rounded-[25px] border-[1px] border-[#E2E8F0]`}  key={projectID}>
            ...
            <p className="font-syne text-[22px]  md:text-[26px] font-bold tracking-[-1.44195px] text-[#1A202C] mt-[21px] mb-[8px] dark:text-[#F7FAFC]">{title}</p>
